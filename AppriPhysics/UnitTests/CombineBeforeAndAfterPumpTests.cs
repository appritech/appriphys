...
namespace UnitTests
{
    ...
    public class CombineBeforeAndAfterPumpTests
    {
        ...
        public void InitializeGraph()
        {
            ...
            Tank t1 = new Tank("T1", 1000.0, plainWater, 500.0, new string[] { "C1" }, false);
            gs.addComponent(t1);
            ...
            gs.addComponent(v2);
            Junction s1 = new Junction("S1", new string[] { "P1" }, new string[] { "V1", "V2" }, "C1", new double[] { 0.5, 0.5 }, new double[] { 0.6, 1.0 });
            gs.addComponent(s1);
            Pump p1 = new Pump("P1", 300.0, 3.2, "S2");
            gs.addComponent(p1);
            Junction s2 = new Junction("S2", new string[] { "V3", "V4" }, new string[] { "P1" }, "C2", new double[] { 0.5, 0.5 }, new double[] { 0.6, 1.0 });
            gs.addComponent(s2);
